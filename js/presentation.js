        ...
        rl.question("", function (input) {
            ...
            switch (choisimoi) {
                case "1":
                    ...
                    break;
                case "2":
                    rl.question("Entre nom de votre collegue : ", function (nom) {
                        rl.question("Entre le prenom : ", function (prenom) { return __awaiter(_this, void 0, void 0, function () {
                            var collegue;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.service.create({ nom: nom, prenom: prenom })];
                                    case 1:
                                        collegue = _a.sent();
                                        this.demarrer();
                                        return [2 /*return*/];
